...
import FormOperator from '../formpage/FormOperator'
...
const MstOperator = () => {
    ...
    async function UpdateStatus(row, valID) {
        ...
        swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios({
                    method: 'put',
                    url: MasterAPI.API_URL + '/OperatorID=' + row.id,
                    data: formData
                }).then((res => {
    ...
    async function GetOperator() {
        ...
        await axios.get(MasterAPI.API_URL + '/GetOperator'
            , {
                params: {
    ...
    const columns = [
        ...
        },
        {
            ...
            text: '',
            formatter: Actions,
            headerStyle: { width: '180px',backgroundColor:'#748DA6' },
            align: 'center'
        },
            ...
            <div style={{ width: "100%" }}>
                ...
                >
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <Typography style={{ fontWeight: 600 }}>Advance Search </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <div>
                            <Box sx={{ width: '100%' }}>
                                <Grid container rowSpacing={3} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                                    ...
                                    <Grid item xs="auto">
                                        <Stack direction="row" spacing={2}>
                                            <h6 style={{ paddingTop: 9 }}>NameEng</h6>
                                            <TextField
                                                id="outlined-basic"
                                                // label="NameEng"
                                                variant="outlined"
                                    ...
                                    <Grid item xs="auto">
                                        <Stack direction="row" spacing={2}>
                                            <h6 style={{ paddingTop: 9 }}>NickName</h6>
                                            <TextField
                                                id="outlined-basic"
                                                // label="NickName"
                                                variant="outlined"
                                    ...
                                    <Grid item xs="auto">
                                        <Stack direction="row" spacing={2}>
                                            <h6 style={{ paddingTop: 9 }}>LineID</h6>
                                            <TextField
                                                id="outlined-basic"
                                                label="LineID"
                                                variant="outlined"
                                ...
                                <Grid container justifyContent="right" style={{ paddingTop: 10 }}>
                                    <Grid item xs={12} sm={'auto'}>
                                        <Button variant="primary" size="small" onClick={() => { GetOperator() }}>Search</Button>
                                    </Grid>
                                </Grid>
                            </Box>
                        </div>
                            ...
                            props => (
                                <div>
                                    <Stack justifyContent="flex-end" direction="row" spacing={2}>
                                        {/* {RoleID === "1" ? */}
                                        <div>
                                            <Button variant="primary" style={{ marginBottom: 10 }} onClick={handleClickAdd}>Add Operator</Button>
                                        </div>
                                        {/* : ""} */}
